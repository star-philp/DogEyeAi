...
from db_handler import connect_to_db, create_table_if_not_exists, save_results_to_db, close_db_connection
...
sample_image_path = 'path/to/your/sample_image.jpg'  # Update this path with the actual path to your sample image
